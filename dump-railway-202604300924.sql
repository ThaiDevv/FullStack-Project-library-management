...
INSERT INTO `ct_phieumuon` VALUES ('PM20260429125634','C113','2026-04-29 14:13:12','Đã trả'),('PM20260429125634','C114',NULL,'Đã trả'),('PM20260429125634','C115','2026-04-29 14:13:12','Đã trả'),('PM20260429141149','C113','2026-04-29 14:15:19','Đã trả'),('PM20260429141149','C114','2026-04-29 14:15:19','Đã trả'),('PM20260429142017','C113','2026-04-29 14:21:14','Đã trả'),('PM20260429142017','C114','2026-04-29 14:21:14','Đã trả'),('PM20260429150400','C113',NULL,'Đang mượn'),('PM20260429150400','C114',NULL,'Đang mượn');
...
INSERT INTO `cuonsach` VALUES ('C101','DS11','Sẵn sàng','Bình Thường'),('C102','DS11','Đang mượn','Bình Thường'),('C103','DS11','Sẵn sàng','Bị Hỏng'),('C104','DS12','Sẵn sàng','Bình Thường'),('C105','DS12','Sẵn sàng','Bình Thường'),('C106','DS13','Đang mượn','Bình Thường'),('C107','DS11','Sẵn sàng','Bình Thường'),('C108','DS11','Sẵn sàng','Bình Thường'),('C109','DS11','Sẵn sàng','Bình Thường'),('C110','DS13','Sẵn sàng','Bình Thường'),('C111','DS13','Sẵn sàng','Bình Thường'),('C112','DS13','Sẵn sàng','Bình Thường'),('C113','DS12','Đang mượn','Bình Thường'),('C114','DS12','Đang mượn','Bình Thường'),('C115','DS12','Sẵn sàng','Bình Thường');
...
INSERT INTO `dausach` VALUES ('DS11','Tâm lý học đám đông','Gustave Le Bon',2020,'TL10'),('DS12','Sapiens - Lược sử loài người','Yuval Noah Harari',2018,'TL11'),('DS13','Việt Nam sử lược','Trần Trọng Kim',2015,'TL11'),('DS14','Dune - Xứ cát','Frank Herbert',2021,'TL12');
...
INSERT INTO `docgia` VALUES ('DG101','Nguyễn Thị Tuyết','2002-12-15','Quận 1, TPHCM','0911222333','Hoạt Động'),('DG102','Trần Hữu Nam','1998-07-22','Quận 3, TPHCM','0922333444','Hoạt Động'),('DG103','Lê Văn Khóa','2001-03-05','Bình Thạnh, TPHCM','0933444555','Bị Khóa'),('DG104','Phạm Quỳnh Như','2005-09-10','Thủ Đức, TPHCM','0944555666','Đã Xóa Độc Giả'),('DG105','Nguyễn Tấn Đạt','1995-11-20','Gò Vấp, TPHCM','0955666777','Hoạt Động'),('DG106','Nguyễn Hoàng Yến','2004-08-08','Quận 7, TPHCM','0988666777','Hoạt Động'),('DG107','Vũ Đồng Hành','2015-04-18','Tân Bình, TPHCM','0977888999','Hoạt Động'),('DG20','Phạm Sinh Viên','2004-05-15','KTX Khu B, Thủ Đức','0888111222','Hoạt Động'),('DG21','Trần Văn Thái','2006-01-06','Bình Thạnh, TPHCM','0559826016','Hoạt Động'),('DG22','Ngô Khóa Thẻ','2005-01-01','Quận 12, TPHCM','0888111444','Bị Khóa'),('DG23','Ha Vi','2006-12-02','Thua Thien Hue','0555111555','Hoạt Động');
...
INSERT INTO `nhanvien` VALUES ('NV04','TranVanThai','0123456789'),('NV06','Nguyen Ngoc Bao Linh','0922222222'),('NV10','Trần Quản Trị','0900111000');
...
INSERT INTO `phieumuon` VALUES ('PM20260429125634','DG21','NV10','2026-04-29 12:56:34','2026-05-10 00:00:00','Hoàn tất'),('PM20260429141149','DG21','NV10','2026-04-29 14:11:49','2026-05-05 00:00:00','Hoàn tất'),('PM20260429142017','DG21','NV10','2026-04-29 14:20:17','2026-04-19 00:00:00','Hoàn tất'),('PM20260429150400','DG21','NV10','2026-04-29 15:04:00','2026-04-19 00:00:00','Đang mượn');
...
INSERT INTO `phieuphat` VALUES (14,'DG21','NV04','PM20260429142017',50000.00,'Trả trễ hạn cuốn sách: C113','Đã thanh toán','2026-04-29 14:21:14','2026-04-29 16:03:36'),(15,'DG21','NV04','PM20260429142017',50000.00,'Trả trễ hạn cuốn sách: C114','Đã thanh toán','2026-04-29 14:21:14','2026-04-30 02:22:04');
...
INSERT INTO `taikhoan` VALUES ('$2b$10$nDnQpin1B5lZ.FXZyaCoSu44GVzfxrmhrc/OlF2yK9KMxXUJU8Smm','NV04','ADMIN',9),('123456','NV10','ADMIN',12);
...
BEGIN
    ...
    -- check trùng số điện thoại (QUAN TRỌNG)
    ELSEIF DienThoaiMoi IS NOT NULL AND EXISTS (
        ...
        SIGNAL SQLSTATE '45000' 
        SET MESSAGE_TEXT = 'Lỗi: Số điện thoại đã tồn tại!';
...
BEGIN
    SELECT
	    ds.MaDauSach,
	    ds.TenSach,
	    COUNT(ct.MaCuonSach) AS SoLuongDangMuon
    FROM thongkesachdangmuon
    WHERE p_MaDocGia IS NULL OR MaDocGia = p_MaDocGia;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2026-04-30  9:25:15
